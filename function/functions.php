<?php
$conn=mysqli_connect("localhost", "root", "","readbook");
//$db=mysqli_select_db("readbook",$conn);	
	...
	while($row=mysqli_fetch_array($result))
	{
		echo "<div class='col-lg-4 col-md-6'>
                            <div class='card'>
                                ...
                                <a href='assets/files/".$row['file']."'><button class='buybtn btn btn-warning btn-round btn-sm'>
                                get<i class='material-icons'>download</i>
                                </button></a>
